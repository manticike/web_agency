...
const FAQS = () => {
    ...
    <AccordionItem value="item-1">
      <AccordionTrigger>What is Mantic Web Agency?</AccordionTrigger>
      <AccordionContent>
        Mantic is a full fledge web development agency that specializes in web design, e-commerce development, shopify stores development and mobile app development.
      </AccordionContent>
    </AccordionItem>
